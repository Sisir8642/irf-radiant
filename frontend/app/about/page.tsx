...
export default function Page() {
    return (
        <div className="min-h-screen bg-gradient-to-br from-[#2B698E] to-[#7ABDE4]">
                    ...
                    <div className="grid lg:grid-cols-2 gap-10 items-stretch">
                        ...
                        >
                            ...
                            <div className="relative z-10">
                                ...
                                <p className="text-gray-300 text-lg leading-8">
                                    To be a premier strategic research institution in South Asia,
                                    amplifying Nepal's voice in regional and global discourse while
                                    producing cutting-edge insights into diplomacy, global governance,
                        ...
                        >
                            ...
                            <div className="space-y-6">
                                ...
                                {[
                                    "To generate policy-relevant research on contemporary global and regional challenges.",
                                    "To shape foreign policy thinking in Nepal and the broader Himalayan region.",
                                    "To create platforms for strategic dialogue among policymakers, academics, business leaders, and civil society.",
                                    "To serve as a bridge between domestic and international policy communities.",
                                    "To build partnerships with leading think tanks, institutions, and development actors globally.",
                                ].map((item, index) => (
                                    <div
                                        key={index}
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[380px_1fr] gap-10 items-center">
                        ...
                        >
                            ...
                            >
                                ...
                                <p className="text-[#7ABDE4] uppercase tracking-[3px] text-sm mt-2">
                                    Chairman, IRF
                                </p>
                            </motion.div>
                        </motion.div>
                            ...
                            <div className="relative z-10">
                                ...
                                >
                                    <svg
                                        ...
                                        fill="currentColor"
                                        viewBox="0 0 24 24"
                                        className="w-14 h-14 text-[#7ABDE4]"
                                    >
                                ...
                                <p className="text-xl md:text-2xl leading-relaxed font-light text-white mb-8">
                                    At a time when the global landscape is defined by
                                    volatility, power transitions, and urgent planetary
                                    challenges, Nepal must find its voice not only as an
                                    observer but as an active contributor to global
                                    discourse.
                                </p>
                                ...
                                <div className="space-y-6 text-white/80 leading-8">
                                    <p>
                                        The Innovate Research Foundation was established
                                        with this conviction.
                                    </p>

                                    <p>
                                        IRF represents more than a think tank; it is a
                                        platform for insight, dialogue, and impact. Our
                                        mission is to generate ideas that matter, shape
                                        policies that endure, and connect Nepal's strategic
                                        thinking to regional and global narratives.
                                    </p>

                                    <p>
                                        As Chairperson, I am proud to lead a team that
                                        values intellectual independence, constructive
                                        engagement, and purpose-driven research.
                                    </p>

                                    <p>
                                        We invite scholars, practitioners, and institutions
                                        to join us in our journey to inform, innovate, and
                                ...
                                <div className="mt-10 pt-8 border-t border-white/10">
                                    ...
                                    <p className="text-[#7ABDE4] tracking-[2px] text-sm uppercase mt-1">
                                        Chairman, Innovate Research Foundation
                                    </p>
                                </div>
                            </div>
                        </motion.div>
            ...
            {/* FOCUS AREAS + WHAT WE DO + IDENTITY */}
            ...
            transition-all duration-300 hover:shadow-xl hover:-translate-y-2 hover:scale-[1.02]">
                                ...
                                <p className="text-gray-600 leading-relaxed">
                                    IRF examines how trade, investment, infrastructure, technology, and connectivity influence international relations, helping Nepal strengthen its economic partnerships and strategic engagement in a rapidly changing global economy.
                                </p>
                            </div>
            ...
            transition-all duration-300 hover:shadow-xl hover:-translate-y-2 hover:scale-[1.02]">
                                ...
                                <p className="text-gray-600 leading-relaxed">
                                    IRF explores climate governance, environmental security, and sustainable development, focusing on how Nepal and Himalayan nations can enhance resilience, influence global climate discussions, and strengthen regional cooperation.
                                </p>
                            </div>
            ...
            transition-all duration-300 hover:shadow-xl hover:-translate-y-2 hover:scale-[1.02]">
                                ...
                                <p className="text-gray-600 leading-relaxed">
                                    IRF studies the role of tourism, culture, heritage, and spirituality in advancing Nepal's soft power, strengthening international partnerships, and creating sustainable economic opportunities through global engagement.
                                </p>
                            </div>
            ...
            transition-all duration-300 hover:shadow-xl hover:-translate-y-2 hover:scale-[1.02]">
                                ...
                                <p className="text-gray-600 leading-relaxed">
                                    Beyond research, IRF serves as a platform for policy dialogue and practical engagement, collaborating with government institutions, the private sector, academia, and civil society to transform ideas into actionable policy outcomes.
                                </p>
                            </div>
            ...
            transition-all duration-300 hover:shadow-xl hover:-translate-y-2 hover:scale-[1.02]">
                                ...
                                <p className="text-gray-600 leading-relaxed">
                                    IRF monitors emerging trends including technological transformation, cybersecurity, artificial intelligence, migration, energy security, and evolving global governance structures that shape Nepal's future policy landscape.
                                </p>
                            </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition border-l-4 border-[#2B698E]">
                                ...
                                <p className="text-gray-600 text-sm leading-relaxed">
                                    IRF is a not-for-profit organization, driven by public service, not commercial interests.
                                </p>
                            </div>
                            <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition border-l-4 border-[#2B698E]">
                                <h3 className="text-xl font-semibold mb-3 text-[#2B698E]">Independent</h3>
                                <p className="text-gray-600 text-sm leading-relaxed">
                                    We maintain academic and intellectual independence while working constructively with a range of stakeholders.
                                </p>
                            </div>
                            <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition border-l-4 border-[#2B698E]">
                                <h3 className="text-xl font-semibold mb-3 text-[#2B698E]">Kathmandu-Based, Globally Oriented</h3>
                                <p className="text-gray-600 text-sm leading-relaxed">
                                    While rooted in Nepal, IRF's perspective is regional and international.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <h2 className="text-4xl font-bold text-[#1E2A3A] mb-4">
                            Flagship Event: The Himalayan Dialogue
                        </h2>
                        <div className="w-24 h-1 bg-[#7ABDE4] mb-10" />
                        ...
                        <div className="bg-gradient-to-r from-[#1E2A3A] to-[#2B698E] rounded-2xl p-8 md:p-12 text-white">
                            ...
                            <p className="mt-6 text-gray-300 text-sm">
                                The Himalayan Dialogue has already established itself as a credible forum for shaping regional thinking and fostering Nepal's strategic voice.
                            </p>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div className="bg-white p-8 rounded-xl shadow-sm  transition-all duration-300 hover:shadow-xl hover:-translate-y-2 hover:scale-[1.02]">
                                ...
                                <p className="text-gray-600 text-sm leading-relaxed">
                                    IRF produces original research through papers, policy briefs, and strategic notes.
                                    We offer deep analysis on current trends, strategic competition, regional diplomacy,
                                    and issue-specific challenges such as energy, trade, and climate.
                                </p>
                            </div>
                            ...
                            <div className="bg-white p-8 rounded-xl shadow-sm  transition-all duration-300 hover:shadow-xl hover:-translate-y-2 hover:scale-[1.02]">
                                ...
                                <p className="text-gray-600 text-sm leading-relaxed">
                                    We host expert roundtables, policy workshops, and conferences to foster dynamic,
                                    multi-stakeholder engagement. Our events bring together diverse voices to explore
                                    shared solutions.
                                </p>
                            </div>
                            ...
                            <div className="bg-white p-8 rounded-xl shadow-sm  transition-all duration-300 hover:shadow-xl hover:-translate-y-2 hover:scale-[1.02]">
                                ...
                                <p className="text-gray-600 text-sm leading-relaxed">
                                    IRF shares evidence-based policy research with government and private stakeholders
                                    to inform real-world decisions. We offer recommendations rooted in evidence and
                            ...
                            <div className="bg-white p-8 rounded-xl shadow-sm  transition-all duration-300 hover:shadow-xl hover:-translate-y-2 hover:scale-[1.02]">
                                ...
                                <p className="text-gray-600 text-sm leading-relaxed">
                                    IRF partners with global think tanks and institutions through joint research,
                                    event partnerships, and institutional exchanges to connect Nepal's perspectives
                            ...
                            <div className="bg-white p-8 rounded-xl shadow-sm  transition-all duration-300 hover:shadow-xl hover:-translate-y-2 hover:scale-[1.02] md:col-span-2">
                                ...
                                <p className="text-gray-600 text-sm leading-relaxed">
                                    Through policy labs, analytical workshops, and young scholar mentorship programs,
                                    IRF develops Nepal's intellectual capacity and future leaders in foreign policy
                                    and strategic affairs.
                                </p>
                            </div>
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="bg-white p-8 rounded-xl shadow-sm border-l-4 border-[#7ABDE4]">
                                <h3 className="text-xl font-semibold mb-3 text-[#2B698E]">
                                    Inaugural Himalayan Dialogue
                                </h3>
                                <p className="text-gray-600 text-sm leading-relaxed">
                                    Successfully organized on April 7, 2025, inaugurated by Prime Minister KP Sharma Oli,
                                    with participation from over 200 policy experts, thought leaders, and international delegates.
                                </p>
                            </div>
                            <div className="bg-white p-8 rounded-xl shadow-sm border-l-4 border-[#7ABDE4]">
                                <h3 className="text-xl font-semibold mb-3 text-[#2B698E]">
                                ...
                                <p className="text-gray-600 text-sm leading-relaxed">
                                    Submission of policy reports and analytical briefs to key ministries and private sector
                                    actors — demonstrating the immediate relevance and practical value of IRF's work in
                    ...
                    <div>
                        ...
                        <div className="bg-gradient-to-br from-white to-slate-50 rounded-2xl p-8 md:p-12 shadow-sm border border-slate-100">
                            ...
                            <p className="text-lg text-gray-600 leading-relaxed max-w-4xl mb-10">
                                IRF actively collaborates with institutions that share our commitment to informed dialogue,
                                evidence-based policymaking, and international cooperation. Whether through joint research,
                                strategic consultation, policy forums, training programs, or regional initiatives, we welcome
                                partnerships that contribute to meaningful policy impact and knowledge exchange.
                            </p>

                            <h3 className="text-xl font-semibold text-[#2B698E] mb-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                ...
                                {[
                                    ...
                                    <div
                                        key={i}
                                        className="bg-white p-6 rounded-xl shadow-sm border-t-4 border-[#2B698E]
                    transition-all duration-300 hover:shadow-xl hover:-translate-y-2 hover:scale-[1.02]"
                                    >
                            ...
                            <div className="mt-12 border-t border-slate-200 pt-8 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                                <div>
                                    <h4 className="text-xl font-semibold text-[#1E2A3A] mb-2">
                                        Let's Build Meaningful Partnerships
                                    </h4>
                                    <p className="text-gray-600">
                                        Together, we can generate ideas, strengthen dialogue, and contribute to
                                        effective policy solutions for Nepal, the region, and beyond.
                                    </p>
                                </div>

                                <a
                                    href="/contact"
                                    className="inline-flex items-center justify-center px-8 py-4 bg-[#2B698E] text-white font-medium rounded-lg transition-all duration-300 hover:bg-[#168dd7] hover:scale-105"
                                >
                                    Become a Partner →
                                </a>
                            </div>
                        ...
                        <div className="bg-white rounded-3xl shadow-lg overflow-hidden">
                            ...
                            <div className="grid lg:grid-cols-3">
                                ...
                                <div className="bg-gradient-to-br from-[#1E2A3A] to-[#2B698E] p-10 text-white flex flex-col justify-center">
                                    ...
                                    <p className="text-[#7ABDE4] mt-2">
                                        Chairman
                                    </p>

                                    <p className="text-gray-300 mt-1">
                                        Innovate Research Foundation (IRF)
                                    </p>

                                    <div className="w-16 h-1 bg-[#7ABDE4] mt-6 mb-6"></div>

                                    <p className="text-gray-300 leading-relaxed">
                                        For research partnerships, policy consultations,
                                        strategic dialogues, institutional collaboration,
                                        or media inquiries, we welcome engagement from
                                ...
                                <div className="lg:col-span-2 p-10">
                                    ...
                                    <div className="grid md:grid-cols-2 gap-6">
                                        ...
                                        <div className=" bg-slate-50 p-5 rounded-r-xl hover:shadow-md transition">
                                        ...
                                        <div className=" bg-slate-50 p-5 rounded-r-xl hover:shadow-md transition">
                                            ...
                                            <a
                                                href="tel:+9779851085096"
                                                className="font-medium text-[#1E2A3A] hover:text-[#2B698E]"
                                            >
                                                +977 9851085096
                                            </a>
                                        </div>
                                        ...
                                        <div className=" bg-slate-50 p-5 rounded-r-xl hover:shadow-md transition">
                                            ...
                                            <a
                                                href="mailto:himalayandialogue.com@gmail.com"
                                                className="font-medium text-[#1E2A3A] break-all hover:text-[#2B698E]"
                                            >
                                                himalayandialogue.com@gmail.com
                                            </a>
                                        </div>
                                        ...
                                        <div className=" bg-slate-50 p-5 rounded-r-xl hover:shadow-md transition">
                                            ...
                                            <a
                                                href="mailto:khanalbro@gmail.com"
                                                className="font-medium text-[#1E2A3A] break-all hover:text-[#2B698E]"
                                            >
                                                khanalbro@gmail.com
                                            </a>
                                    ...
                                    <div className="mt-8 bg-[#F8FAFC] p-6 rounded-xl border border-slate-200">
                                        <p className="text-sm text-gray-500 mb-2">
                                            Official Website
                                        </p>

                                        <a
                                            href="https://irf.org.np"
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="text-[#2B698E] font-semibold hover:text-[#1E2A3A] transition"
                                        >
                                            www.irf.org.np →
                                        </a>
                                    </div>
            ...
            <section className="bg-[#1E2A3A] py-10">
                <div className="max-w-7xl mx-auto px-6 text-center">
                    <p className="text-white text-lg font-medium tracking-wide">
                        IRF: Navigating Complexity. Influencing Policy. Empowering Ideas.
                    </p>
                </div>
            </section>
