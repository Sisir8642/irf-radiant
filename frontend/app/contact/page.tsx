...
export default function ContactPage() {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: Mail,
      title: "Email Us",
      content: "himalyandialogue.com@gmail.com",
      bgColor: "bg-[#7ABDE4]",
      iconColor: "text-[#2B698E]"
    }
  ];
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-10">
          <div className="mb-8">
            ...
            <ul className="list-disc list-inside text-gray-700 mb-4 space-y-1">
              <li>International think tanks and research institutions</li>
              <li>National and provincial governments</li>
              <li>Private sector stakeholders and chambers of commerce</li>
              <li>Universities, scholars, and policy schools</li>
              <li>Multilateral and development partners</li>
            </ul>
            <p className="text-gray-700 mb-4">
              Whether it’s joint research, strategic consultation, policy workshops, or regional programs, we invite like-minded institutions to work with us in advancing knowledge and shaping policy for a better, more cooperative world.
            </p>
            <h3 className="text-xl font-semibold text-gray-800 mb-4">Contact Us Via Mail</h3>
          </div>
          ...
          <div className="space-y-6">
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-[#2B698E] to-[#7ABDE4] hover:from-[#24618A] hover:to-[#68ADD9] text-white font-semibold py-4 rounded-lg transition-all duration-300 flex items-center justify-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-xl"
            >
              <Send size={20} />
